...
export const CALL_QUEUE_DEFAULT_DEFS = [
  ...
  { table_view: 'call_queue', column_key: 'last_contacted_at', column_label: 'Last contacted', column_type: 'date', is_visible: false, is_default: true, sort_order: 6, dropdown_options: [] },
  { table_view: 'call_queue', column_key: 'outcome', column_label: 'Outcome', column_type: 'text', is_visible: true, is_default: true, sort_order: 7, dropdown_options: [] },
  { table_view: 'call_queue', column_key: 'attempts', column_label: 'Attempts', column_type: 'number', is_visible: true, is_default: true, sort_order: 8, dropdown_options: [] },
  { table_view: 'call_queue', column_key: 'priority', column_label: 'Priority', column_type: 'priority', is_visible: false, is_default: true, sort_order: 9, dropdown_options: [] },
  { table_view: 'call_queue', column_key: '_actions', column_label: 'Actions', column_type: 'actions', is_visible: true, is_default: true, sort_order: 10, dropdown_options: [] },
];
